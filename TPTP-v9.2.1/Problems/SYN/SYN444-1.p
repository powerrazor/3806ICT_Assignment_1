%--------------------------------------------------------------------------
% File     : SYN444-1 : TPTP v9.2.1. Released v2.1.0.
...
% Source   : [Wei97]
% Names    : alc-4-1-60-3-1-013.cnf [Wei97]

% Status   : Unsatisfiable
% Rating   : 0.00 v7.0.0, 0.14 v6.4.0, 0.00 v6.2.0, 0.25 v6.1.0, 0.12 v6.0.0, 0.00 v4.0.1, 0.20 v3.7.0, 0.00 v3.1.0, 0.22 v2.7.0, 0.17 v2.6.0, 0.44 v2.5.0, 0.00 v2.4.0, 0.50 v2.3.0, 0.33 v2.2.1, 0.00 v2.2.0, 0.67 v2.1.0
% Syntax   : Number of clauses     :  176 (   0 unt;  59 nHn; 164 RR)
%            Number of literals    :  658 (   0 equ; 369 neg)
