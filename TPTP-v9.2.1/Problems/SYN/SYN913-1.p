%--------------------------------------------------------------------------
% File     : SYN913-1 : TPTP v9.2.1. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF converse PDL, SSS - K=4 C=50 V=4 D=4.6
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cpdl-cnfSSS-K4-C50-V4-D4.6 [Sch01]

% Status   : Satisfiable
% Rating   : 0.00 v6.3.0, 0.33 v6.2.0, 0.20 v6.1.0, 0.00 v5.5.0, 0.25 v5.4.0, 0.78 v5.3.0, 0.71 v5.0.0, 0.88 v4.1.0, 0.86 v4.0.0, 0.88 v3.5.0, 0.86 v3.4.0, 0.67 v3.3.0, 0.83 v3.2.0, 0.80 v3.1.0, 0.71 v2.7.0, 0.80 v2.6.0, 1.00 v2.5.0
% Syntax   : Number of clauses     : 1301 (  51 unt; 126 nHn;1301 RR)
%            Number of literals    : 5131 (   0 equ;3784 neg)
%            Maximal clause size   :    5 (   3 avg)
%            Maximal term depth    :    2 (   1 avg)
%            Number of predicates  : 1220 (1220 usr;  51 prp; 0-2 aty)
%            Number of functors    :   86 (  86 usr;  51 con; 0-1 aty)
%            Number of variables   : 3731 (   0 sgn)
% SPC      : CNF_SAT_RFO_NEQ
