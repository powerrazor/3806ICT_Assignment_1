%--------------------------------------------------------------------------
% File     : SYN453-1 : TPTP v9.2.1. Released v2.1.0.
...
% Source   : [Wei97]
% Names    : alc-4-1-60-3-1-044.cnf [Wei97]

% Status   : Satisfiable
% Rating   : 0.00 v7.3.0, 0.25 v7.0.0, 0.00 v6.2.0, 0.33 v6.1.0, 0.40 v6.0.0, 0.33 v5.5.0, 0.00 v5.4.0, 0.33 v5.3.0, 0.40 v5.2.0, 0.00 v5.0.0, 0.57 v4.1.0, 0.38 v4.0.1, 0.00 v3.7.0, 0.33 v3.5.0, 0.00 v3.4.0, 0.20 v3.3.0, 0.33 v3.2.0, 0.00 v3.1.0, 0.33 v2.7.0, 0.50 v2.5.0, 0.60 v2.4.0, 0.33 v2.2.1, 0.67 v2.2.0, 0.50 v2.1.0
% Syntax   : Number of clauses     :  344 (   0 unt;  58 nHn; 335 RR)
%            Number of literals    :  971 (   0 equ; 575 neg)
