%--------------------------------------------------------------------------
% File     : SYN909-1 : TPTP v9.2.1. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF converse PDL, SSS - K=4 C=30 V=4 D=6.2
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cpdl-cnfSSS-K4-C30-V4-D6.2 [Sch01]
...
% Syntax   : Number of clauses     : 1051 (  31 unt;  73 nHn;1051 RR)
%            Number of literals    : 4157 (   0 equ;3089 neg)
%            Maximal clause size   :    5 (   3 avg)
%            Maximal term depth    :    2 (   1 avg)
%            Number of predicates  :  974 ( 974 usr;  31 prp; 0-2 aty)
%            Number of functors    :   82 (  82 usr;  31 con; 0-1 aty)
%            Number of variables   : 3047 (   0 sgn)
% SPC      : CNF_SAT_RFO_NEQ
