%--------------------------------------------------------------------------
% File     : SYN910-1 : TPTP v9.2.1. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF converse PDL, SSS - K=4 C=30 V=8 D=4.3
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cpdl-cnfSSS-K4-C30-V8-D4.3 [Sch01]

% Status   : Satisfiable
% Rating   : 0.00 v5.5.0, 0.25 v5.4.0, 0.78 v5.3.0, 0.71 v5.0.0, 0.50 v4.1.0, 0.43 v4.0.0, 0.50 v3.5.0, 0.57 v3.4.0, 0.50 v3.2.0, 0.60 v3.1.0, 0.57 v2.7.0, 0.80 v2.6.0, 1.00 v2.5.0
% Syntax   : Number of clauses     : 1434 (  31 unt;  79 nHn;1434 RR)
%            Number of literals    : 5952 (   0 equ;4497 neg)
%            Maximal clause size   :    5 (   4 avg)
%            Maximal term depth    :    2 (   1 avg)
%            Number of predicates  : 1346 (1346 usr;  31 prp; 0-2 aty)
%            Number of functors    :   98 (  98 usr;  31 con; 0-1 aty)
%            Number of variables   : 4459 (   0 sgn)
% SPC      : CNF_SAT_RFO_NEQ
