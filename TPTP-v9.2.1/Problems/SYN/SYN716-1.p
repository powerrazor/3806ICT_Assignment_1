%--------------------------------------------------------------------------
% File     : SYN716-1 : TPTP v9.2.1. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4756
% Version  : Especial.
% English  :
...
%            Number of literals    :  240 (   0 equ; 136 neg)
...
cnf(not_p62_34,negated_conjecture,
    ~ p62(c67,c72) ).
...
cnf(p58_40,negated_conjecture,
    ( p58(X183,X184)
    | ~ p58(X182,X183)
    | ~ p58(X182,X184) ) ).

cnf(p56_41,negated_conjecture,
    ( p56(X176,X177)
    | ~ p56(X175,X176)
    | ~ p56(X175,X177) ) ).

cnf(p54_42,negated_conjecture,
    ( p54(X169,X170)
    | ~ p54(X168,X169)
    | ~ p54(X168,X170) ) ).

cnf(p52_43,negated_conjecture,
    ( p52(X162,X163)
    | ~ p52(X161,X162)
    | ~ p52(X161,X163) ) ).

cnf(p50_44,negated_conjecture,
    ( p50(X159,X160)
    | ~ p50(X158,X159)
    | ~ p50(X158,X160) ) ).

cnf(p48_45,negated_conjecture,
    ( p48(X152,X153)
    | ~ p48(X151,X152)
    | ~ p48(X151,X153) ) ).

cnf(p46_46,negated_conjecture,
    ( p46(X145,X146)
    | ~ p46(X144,X145)
    | ~ p46(X144,X146) ) ).

cnf(p44_47,negated_conjecture,
    ( p44(X138,X139)
    | ~ p44(X137,X138)
    | ~ p44(X137,X139) ) ).
...
cnf(p34_53,negated_conjecture,
    ( p34(X96,X97)
    | ~ p34(X95,X96)
    | ~ p34(X95,X97) ) ).

cnf(p32_54,negated_conjecture,
    ( p32(X93,X94)
    | ~ p32(X92,X93)
    | ~ p32(X92,X94) ) ).

cnf(p30_55,negated_conjecture,
    ( p30(X90,X91)
    | ~ p30(X89,X90)
    | ~ p30(X89,X91) ) ).
...
cnf(p28_57,negated_conjecture,
    ( p28(X72,X73)
    | ~ p28(X71,X72)
    | ~ p28(X71,X73) ) ).

cnf(p26_58,negated_conjecture,
    ( p26(X65,X66)
    | ~ p26(X64,X65)
    | ~ p26(X64,X66) ) ).

cnf(p24_59,negated_conjecture,
    ( p24(X58,X59)
    | ~ p24(X57,X58)
    | ~ p24(X57,X59) ) ).

cnf(p22_60,negated_conjecture,
    ( p22(X51,X52)
    | ~ p22(X50,X51)
    | ~ p22(X50,X52) ) ).

cnf(p20_61,negated_conjecture,
    ( p20(X48,X49)
    | ~ p20(X47,X48)
    | ~ p20(X47,X49) ) ).
...
cnf(p18_63,negated_conjecture,
    ( p18(X38,X39)
    | ~ p18(X37,X38)
    | ~ p18(X37,X39) ) ).

cnf(p17_64,negated_conjecture,
    ( p17(X31,X32)
    | ~ p17(X30,X31)
    | ~ p17(X30,X32) ) ).

cnf(p15_65,negated_conjecture,
    ( p15(X24,X25)
    | ~ p15(X23,X24)
    | ~ p15(X23,X25) ) ).

cnf(p14_66,negated_conjecture,
    ( p14(X17,X18)
    | ~ p14(X16,X17)
    | ~ p14(X16,X18) ) ).

cnf(p12_67,negated_conjecture,
    ( p12(X14,X15)
    | ~ p12(X13,X14)
    | ~ p12(X13,X15) ) ).
...
cnf(p24_77,negated_conjecture,
    ( p24(f27(X60,X61),f27(X62,X63))
    | ~ p15(X61,X63)
    | ~ p26(X60,X62) ) ).

cnf(p26_78,negated_conjecture,
    ( p26(f29(X67,X68),f29(X69,X70))
    | ~ p18(X68,X70)
    | ~ p28(X67,X69) ) ).

cnf(p28_79,negated_conjecture,
...
cnf(p7_96,negated_conjecture,
    ( p7(f33(X218,X219),f33(X220,X221))
    | ~ p15(X218,X220)
    | ~ p32(X219,X221) ) ).
...
cnf(p63_101,negated_conjecture,
    ( p63(f36(f39(f41(c73,X213),X214),X211),X212)
    | ~ p63(f36(f39(f41(c73,X211),X212),X213),X214) ) ).
...
cnf(not_p63_103,negated_conjecture,
    ( ~ p63(f36(f39(f41(c73,X10),X11),f37(X8,X12)),f33(X9,X12))
    | ~ p62(f23(f25(f27(f29(f31(c74,X7),X8),X9),X10),X11),X12) ) ).

cnf(p10_104,negated_conjecture,
    ( p10(f37(f43(f45(f47(f49(f51(c75,X7),X8),X9),X10),X11),X12),f37(X8,X12))
    | ~ p62(f23(f25(f27(f29(f31(c74,X7),X8),X9),X10),X11),X12) ) ).

cnf(p7_105,negated_conjecture,
    ( p7(f33(f53(f55(f57(f59(f61(c76,X7),X8),X9),X10),X11),X12),f33(X9,X12))
    | ~ p62(f23(f25(f27(f29(f31(c74,X7),X8),X9),X10),X11),X12) ) ).

cnf(p3_106,negated_conjecture,
    p3(f8(f11(f13(c65,f16(f19(f21(c66,X7),X8),X9)),X10),X11),f16(f19(f21(c66,f23(f25(f27(f29(f31(c74,X7),X8),X9),X10),X11)),f43(f45(f47(f49(f51(c75,X7),X8),X9),X10),X11)),f53(f55(f57(f59(f61(c76,X7),X8),X9),X10),X11))) ).
