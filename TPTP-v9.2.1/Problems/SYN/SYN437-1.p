%--------------------------------------------------------------------------
% File     : SYN437-1 : TPTP v9.2.1. Released v2.1.0.
...
% Source   : [Wei97]
% Names    : alc-4-1-48-3-1-082.cnf [Wei97]

% Status   : Satisfiable
% Rating   : 0.00 v7.3.0, 0.25 v7.0.0, 0.00 v6.2.0, 0.33 v6.1.0, 0.40 v6.0.0, 0.00 v5.4.0, 0.17 v5.3.0, 0.20 v5.2.0, 0.00 v5.0.0, 0.43 v4.1.0, 0.25 v4.0.1, 0.00 v3.1.0, 0.17 v2.7.0, 0.25 v2.6.0, 0.50 v2.5.0, 0.40 v2.4.0, 0.33 v2.2.1, 1.00 v2.1.0
% Syntax   : Number of clauses     :  256 (   0 unt;  47 nHn; 250 RR)
%            Number of literals    :  761 (   0 equ; 463 neg)
