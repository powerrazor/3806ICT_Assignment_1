%--------------------------------------------------------------------------
% File     : SYN488-1 : TPTP v9.2.1. Released v2.1.0.
...
% Source   : [Wei97]
% Names    : alc-4-1-76-3-1-086.cnf [Wei97]

% Status   : Unsatisfiable
% Rating   : 0.00 v7.0.0, 0.14 v6.4.0, 0.00 v6.2.0, 0.25 v6.1.0, 0.12 v6.0.0, 0.00 v5.0.0, 0.17 v4.1.0, 0.40 v3.7.0, 0.25 v3.5.0, 0.00 v3.1.0, 0.22 v2.7.0, 0.50 v2.6.0, 0.56 v2.5.0, 0.00 v2.4.0, 0.50 v2.3.0, 0.33 v2.2.1, 0.00 v2.2.0, 0.67 v2.1.0
% Syntax   : Number of clauses     :  204 (   0 unt;  76 nHn; 193 RR)
%            Number of literals    :  776 (   0 equ; 419 neg)
